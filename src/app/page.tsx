      ...
      <div className="mx-auto grid grid-cols-4 gap-5">
        <div className="pt-10 px-5">
          <div className="flex flex-wrap justify-center">
            <div className="w-2/5 sm:w-2/5 px-4">
          ...
          <div className="flex flex-wrap justify-center pt-10 font-['Rajdhani'] text-blue-950 font-semibold text-lg">
            <a href="#">Home</a>
          </div>
          <div className="flex flex-wrap justify-center font-['Rajdhani'] text-blue-950 font-semibold text-lg">
            <a href="#">About</a>
          </div>
          <div className="flex flex-wrap justify-center font-['Rajdhani'] text-blue-950 font-semibold text-lg">
            <a href="#">Project</a>
        ...
        <div className="col-span-3 text-7xl bg-blue-50 pt-10 h-screen">
          <div className="grid grid-cols-2 gap-3 px-20">
            <div className="pt-28">
              ...
              <p className="font-['Rajdhani'] text-base font-semibold text-blue-950">Maguwoharjo, Sleman, Yogyakarta</p>
