...
function BlogPage() {
  ...
  return (
      ...
      <div className="col-span-2">
        <div>
          {blogPosts.map((post) => (
            <div key={post.id} className="p-5 bg-white rounded-lg flex flex-wrap justify-center grid grid-cols-4 gap-4">
                <div>
                ...
                <div className="col-span-3">
                    ...
                    <p className="text-sm font-['Rajdhani'] text-blue-900 truncate">{post.content}</p> 
                    
                      <Link href={`/detailBlog?id=${post.id}`} passHref>
                          READ MORE
                      </Link>
