...
function BlogPage() {
  ...
  return (
    <div className="grid grid-cols-3 gap-4 px-20 py-20 bg-blue-50" id="blog">
      <div>
        <h1 className="font-['Rajdhani'] text-lg font-semibold pb-1 text-blue-950">
          - BLOG
        </h1>
        <h1 className="font-['Rajdhani'] text-5xl font-black text-blue-950">
          My blog & news
        </h1>
      ...
      <div className="col-span-2">
        <div>
          {blogPosts.map((post) => (
            <div
              key={post.id}
              className="p-5 bg-white rounded-lg flex flex-wrap justify-center grid grid-cols-4 gap-4 mb-5"
            >
              <div>
                <Image
                  src={post.imageUrl}
              ...
              <div className="col-span-3">
                <p className="text-lg font-['Rajdhani'] font-semibold text-blue-950">
                  {post.title}
                </p>
                <p className="text-xs font-['Rajdhani'] pb-1 text-blue-900">
                  {post.date}
                </p>
                <p className="text-sm font-['Rajdhani'] text-blue-900 truncate mb-0">
                  {post.content}
                </p>
                <div className="flex pt-2 ">
                  <button
                    className="font-['Rajdhani'] text-red-600 text-sm font-bold pt-1"
        ...
        <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-70">
          <div className="bg-white p-8 rounded-lg">
            <div className="flex justify-end">
              <button
                className="bg-blue-950 hover:bg-blue-900 text-white py-2 px-2 mb-5 rounded "
            ...
            <div className="flex items-center mb-4">
              <div className="ml-4">
                <div className="flex items-center mb-2 mt-5">
                  ...
                  <p className="text-xs text-blue-900 ml-2">
                    {selectedPost.date}
                  </p>
                </div>
